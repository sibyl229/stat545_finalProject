...
myggsave('figure/region_SouthAsiaTotalAttackes.png')
...
myggsave('figure/region_numAttackesVsNumKilled.png')
...
myggsave('figure/region_attacksVsKilledRegional.png')
...
pEventTrend2 + geom_point(alpha=0.3) + scale_size_area(max_size=10) + 
  geom_smooth(method='loess') 
myggsave('figure/region_attacksVsKilledMiddleEast.png')
